const i18n = {
    vi: {
        ...
        'reg.screenshotHint': '📸 Vui lòng chụp màn hình lưu lại để tránh mất tài khoản',
        'reg.screenshotBtn': 'Lưu ảnh chụp màn hình',
    ...
    cn: {
        ...
        'reg.screenshotHint': '📸 建议截图保存账号信息，防止丢失',
        'reg.screenshotBtn': '保存截图',
